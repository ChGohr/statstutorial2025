...
# for a second model remove transmission factor with type III
model_2 <- 
model_2

#for a third model remove interactions between engine and gear type II
model_3 <- 
model_3

#create model 4 by running an Anova for engine and transmission type III
model_4 <- 
model_4

#remove interactions of model 4 type II
model_5 <- 
model_5

# create model 6 with all three factors but without interactions type II
model_6 <- 
model_6
